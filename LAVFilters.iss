...
begin
  FR(SplitterFormats[0], 'matroska', 'Matroska/WebM (with H.265/HEVC support)', True, ['mkv','mka', 'mks', 'mk3d', 'webm', '']);
  ...
  FP(SplitterFormats[15], 'rtsp', 'RTSP Streaming Protocol', False, ['rtsp', 'rtspu', 'rtspm', 'rtspt', 'rtsph', '']);
  FP(SplitterFormats[16], 'rtp', 'RTP Streaming Protocol', False, ['rtp', '']);
  FP(SplitterFormats[17], 'mms', 'MMS Streaming Protocol', False, ['mms', 'mmsh', 'mmst', '']);

  FR(SplitterFormats[18], 'dts', 'DTS Audio', False, ['dts', 'dtshd', '']);
  FR(SplitterFormats[19], 'ac3', 'AC3 Audio', False, ['ac3', 'eac3', '']);
  FR(SplitterFormats[20], 'aac', 'AAC Audio', False, ['aac', '']);
  FR(SplitterFormats[21], 'mp3', 'MP3 Audio', False, ['mp3', '']);
  FR(SplitterFormats[22], 'flac', 'FLAC Audio', False, ['flac', '']);
end;
