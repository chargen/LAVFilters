...
set MSYS_FILENAME=MSYS_MinGW-w64_GCC_492_x86-x64.7z
if not exist "C:\MSYS" (
    echo Fetching MSYS/MinGW...
    PowerShell Invoke-WebRequest -Uri http://xhmikosr.1f0.de/tools/msys/old/%MSYS_FILENAME% -OutFile "C:\Users\vagrant\%MSYS_FILENAME%"
